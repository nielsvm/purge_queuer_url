...
/**
 * @file
 * Contains \Drupal\Tests\purge_queuer_url\Unit\UrlAndPathQueuerTest.
 */

namespace Drupal\Tests\purge\Unit;

use Drupal\purge_queuer_url\CacheTagsQueuer;
use Drupal\Tests\UnitTestCase;

/**
 * @coversDefaultClass \Drupal\purge_queuer_url\CacheTagsQueuer
 * @group purge_queuer_url
 */
class UrlAndPathQueuerTest extends UnitTestCase {

  /**
   * The tested cache tags queuer.
   *
   * @var \Drupal\purge_queuer_url\UrlQueuer
   */
