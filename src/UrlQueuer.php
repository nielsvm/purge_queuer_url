...
/**
 * @file
 * Contains \Drupal\purge_queuer_url\UrlQueuer.
 */
 ...
 *
 */
class UrlQueuer implements CacheTagsInvalidatorInterface, ContainerAwareInterface {
  ...
  //  *
  //  * @var false|\Drupal\purge_queuer_url\Plugin\Purge\Queuer\CoreTagsQueuer
  //  */
  // protected $queuer;
