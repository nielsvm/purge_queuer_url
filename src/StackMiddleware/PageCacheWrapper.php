...
/**
 * @file
 * Contains \Drupal\purge_queuer_url\StackMiddleware\PageCacheWrapper.
 */
 ...
 *
 */
class PageCacheWrapper extends PageCache implements HttpKernelInterface {
  ...
  /**
   * Constructs a PageCacheWrapper object.
   *
